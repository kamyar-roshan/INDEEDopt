import sys
Path2script = "/storage/home/kar/scratch/INDEEDopt/"
...
from ffield_generator.generate_training_folder import generate_training_folder_v1
...
def func(values, j):
    ...
    try:
        ...
        generate_training_folder_v1(folder_name)
